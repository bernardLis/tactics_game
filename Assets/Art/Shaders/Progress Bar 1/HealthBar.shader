    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                float waveOffset = _waveAmp*cos(_waveFreq*(IN.uv.x + _Time.y*_waveSpeed)) * min(1.3f*sin(PI * _fill), 1);
                ...
                float healthMapped = lerp(fillOffset -0.01f, 1 - fillOffset, _fill);
