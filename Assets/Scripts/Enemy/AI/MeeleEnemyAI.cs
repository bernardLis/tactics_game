...
public class MeeleEnemyAI : EnemyAI
{
    ...
    protected override GameObject GetTargetCharacter()
    {
        ...
        Dictionary<GameObject, float> distToPlayerCharacters = new Dictionary<GameObject, float>();
        ...
        foreach (var playerCharacter in playerCharacters)
        {
            ...
            distToPlayerCharacters.Add(playerCharacter, distance);
        }

        var sortedDict = from entry in distToPlayerCharacters orderby entry.Value ascending select entry;
        /*
        ...
        */
        ...
        foreach (KeyValuePair<GameObject, float> entry in sortedDict)
        {
            // we are returning the closest character that has a free tile around him
            if (CheckTilesAroundCharacter(entry.Key))
            {
                targetCharacter = entry.Key;
        ...
        targetCharacter = distToPlayerCharacters.First().Key;
        return targetCharacter;
    }
