...
public class PlayerCharInteractionController : CharacterInteractionController
{
	...
	protected override void Awake()
	{
		...
		controls.Player.QButtonClick.performed += ctx => QButtonClickInput();
		controls.Player.WButtonClick.performed += ctx => WButtonClickInput();
		controls.Player.EButtonClick.performed += ctx => EButtonClickInput();
		controls.Player.RButtonClick.performed += ctx => RButtonClickInput();
