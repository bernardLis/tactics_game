...
namespace Lis
{
    public class EntityScreen : FullScreenElement
    {
        const string _ussCommonTextPrimary = "common__text-primary";

        protected const string _ussClassName = "entity-screen__";
        ...
        public EntityScreen(Entity entity) : base()
        {
            var ss = _gameManager.GetComponent<AddressableManager>().GetStyleSheetByName(StyleSheetType.EntityScreenStyles);
            if (ss != null)
                styleSheets.Add(ss);
