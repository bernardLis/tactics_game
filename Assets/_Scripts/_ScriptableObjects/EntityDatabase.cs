...
public class EntityDatabase : ScriptableObject
{
    ...
    {
        List<HeroRank> sorted = HeroRanks.OrderBy(o => o.Rank).ToList();

        HeroRank r = HeroRanks[0];
        foreach (HeroRank rank in HeroRanks)
    ...
    public List<HeroPortrait> GetAllPortraits()
    {
        List<HeroPortrait> l = new();
        l.AddRange(PortraitsMale);
        l.AddRange(PortraitsFemale);
        return l;
    }
    public HeroPortrait GetPortraitById(string id)
    {
        List<HeroPortrait> allPortraits = new();
    ...
    public HeroPortrait GetRandomPortraitMale() { return PortraitsMale[Random.Range(0, PortraitsMale.Count)]; }
    public HeroPortrait GetRandomPortraitFemale() { return PortraitsFemale[Random.Range(0, PortraitsFemale.Count)]; }

    public string GetRandomNameMale() { return HeroNamesMale[Random.Range(0, HeroNamesMale.Length)]; }
    public string GetRandomNameFemale() { return HeroNamesFemale[Random.Range(0, HeroNamesFemale.Length)]; }

    public string[] HeroNamesMale = {
    "Liam",
    "Noah",
    "Oliver",
    "Elijah",
