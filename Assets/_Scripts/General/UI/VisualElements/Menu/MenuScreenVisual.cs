...
public class MenuScreenVisual : FullScreenVisual
{

    public MenuScreenVisual(VisualElement root)
    {
        Initialize(root);
    ...
    {
        base.Hide();
        GameManager.Instance.GetComponent<GameUIManager>().SetIsMenuOpen(false);
    }
}
