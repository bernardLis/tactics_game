...
{
    public class FireTrainingController : BuildingController, IInteractable
    {
        [Header("Fire Training")]
        ...
        {
            Building = GameManager.Campaign.FireTrainingBuilding;
        ...
        {
            base.SetWorker(ucc);
            CampConsoleManager.ShowMessage($"Unit assigned to Fire Training Building.");
            ucc.StartHouseCoroutine(_standPoint);
        }
    }
}