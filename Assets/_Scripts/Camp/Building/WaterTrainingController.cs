...
{
    public class WaterTrainingController : BuildingController, IInteractable
    {
        ...
        {
            Building = GameManager.Campaign.WaterTrainingBuilding;
        ...
        {
            base.SetWorker(ucc);
            CampConsoleManager.ShowMessage($"Unit assigned to Water Training Building.");
            ucc.StartHouseCoroutine(_standPoint);
        }
    }
}